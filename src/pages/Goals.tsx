                  ...
                  <div key={goal.id} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div className="space-y-3 mb-6">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-sm font-medium text-secondary">{formatCurrency(goal.monthlyContribution)}</span>
                      </div>
                    </div>
                    ...
                    <div className="mt-6 flex space-x-3">
                      <button className="flex-1 bg-primary/10 text-primary px-4 py-2 rounded-lg text-sm font-medium hover:bg-primary/20 transition-colors">
                        Adjust Goal
                      </button>
                      <button className="flex-1 bg-secondary/10 text-secondary px-4 py-2 rounded-lg text-sm font-medium hover:bg-secondary/20 transition-colors">
                        Add Funds
                      </button>
                    </div>
                  </div>
